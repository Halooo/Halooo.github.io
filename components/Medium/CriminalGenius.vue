<template>
  <div class="w-30%">
    <div class="mt-170 d1 opacity-0">
      <div ref="floorBox" class="text-26px PPHattonMedium">CRIMINAL GENIUS</div>
      <ul class="text-xl mt-5 leading-10 PolySansSlim italic capitalize">
        <li class="flex items-center space-x-3">
          <span class="bg-white w-2 h-2 rounded-full"></span>
          <span class="whitespace-nowrap">Golden Empire</span>
        </li>
        <li class="flex items-center space-x-3">
          <span class="bg-white w-2 h-2 rounded-full"></span>
          <span class="whitespace-nowrap">Sister Ping</span>
        </li>
        <li class="flex items-center space-x-3">
          <span class="bg-white w-2 h-2 rounded-full"></span>
          <span class="whitespace-nowrap">The Innkeeper</span>
        </li>
        <li class="flex items-center space-x-3">
          <span class="bg-white w-2 h-2 rounded-full"></span>
          <span class="whitespace-nowrap">Torrential Night</span>
        </li>
      </ul>
    </div>
  </div>
